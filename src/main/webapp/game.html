...
<title>Rock Paper Scissors!!!</title>																																																						<html>
   ...
   <body>
      ...
      <a href="#" onclick="playShivasambo('rock')"> rock </a>
      <a href="#" onclick="playShivasambo('paper')"> paper </a>
      <a href="#" onclick="playShivasambo('scissors')"> scissors </a>
...
playShivasambo = function(clientGesture) {
	console.log("************** Playing Shivasambo *****************");
